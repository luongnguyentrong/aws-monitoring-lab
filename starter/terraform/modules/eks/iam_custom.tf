...
data "aws_iam_policy" "eks_cluster_role_cloudwatch_policy" {
  arn = "arn:aws:iam::790956068077:policy/app-udacity-eks-cluster-role-cloudwatch-policy"
}

data "aws_iam_policy" "eks_node_instance_policy" {
  arn = "arn:aws:iam::790956068077:policy/app-udacity-instance-policy"
}